            ...
            Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Text(ModuleData[itemIndex]['letter'],style: TextStyle(fontSize: 100),),
                ),
                ModuleData[itemIndex]['image']==null?
                    CircularProgressIndicator():
                Align(
                  alignment: Alignment.center,
                  child: Image.network(Constant.driveUrl+ModuleData[itemIndex]['image'],
                  height: 220,
                  width: 220,
                    fit: BoxFit.contain,
                    loadingBuilder: (BuildContext? ctx, Widget? child, ImageChunkEvent? loadingProgress) {
                      if (loadingProgress == null) {
                        return Image.network(Constant.driveUrl+ModuleData[itemIndex]['image'],
                ...
                Container(
                  ...
                  child: Center(
                    child: Text(ModuleData[itemIndex]['name'],style: TextStyle(
                ...
                Container(
                  ...
                  width: MediaQuery.of(context).size.width,
                  child: Center(
                    child: Text(ModuleData[itemIndex]['desc'],style: TextStyle(
                ...
                Align(
                  ...
                  child: GestureDetector(
                      onTap: () async {
                        ...
                        await player.play(Constant.driveUrl+ModuleData[itemIndex]['audio'],
                        isLocal:true
                        );
